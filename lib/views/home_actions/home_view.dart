              ...
              child: Row(
                children: [
                  ...
                  _buildTopIcon(
                    image: "search.png",
                    onTap: () {
                      context.go(AppRoutesName.search);
                    },
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Column(
                          children: [
                            CarouselSlider(
                              items: provider.homeData!.bannerImages.map((
                                image,
                              ) {
                                return ClipRRect(
                            ...
                            return Padding(
                              ...
                              child: Row(
                                ...
                                children: List.generate(
                                  ...
                                  (index) {
                                    final section =
                                        provider.homeData!.sectionImages[index];
    ...
    return SingleChildScrollView(
      ...
      child: Consumer<HomeProvider>(
        builder: (context, provider, child) {
          ...
          return Row(
            children: List.generate(provider.homeData!.topSelling.length, (
              index,
            ) {
    ...
    return SingleChildScrollView(
      ...
      child: Consumer<HomeProvider>(
        builder: (context, provider, child) {
          ...
          return Row(
            children: List.generate(
              provider.homeData!.outdoorCollection.length,
              (index) {
